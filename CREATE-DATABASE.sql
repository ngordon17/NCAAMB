...
CREATE TABLE Game (
	id VARCHAR(100) NOT NULL PRIMARY KEY,
	home_team_id VARCHAR(100) NOT NULL DEFAULT 'UNKNOWN', -- reference
	away_team_id VARCHAR(100) NOT NULL DEFAULT 'UNKNOWN', -- reference
...
CREATE TABLE GameStats (
	...
	player_id VARCHAR(100), --referencing player id
