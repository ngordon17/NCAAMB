...
CREATE TABLE Game (
	id VARCHAR(100) PRIMARY KEY,
	home_team_id VARCHAR(100) REFERENCES Team(id),
	away_team_id VARCHAR(100) REFERENCES Team(id),
	--venue_id VARCHAR(100),
	scheduled_datetime timestamp DEFAULT '1900-01-01 00:00:00'
	--network VARCHAR(100),
...
CREATE TABLE GameStats (
	game_id VARCHAR(100) REFERENCES Game(id),
